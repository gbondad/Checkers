...
--main = blackAi (black_Ai) applyMove initialGameState
main = aiTest (red_Ai)  (black_Ai) applyMove initialGameState
...
bestMove st (m:ms) m' s 
                ...
                where score = (minimax (applyMove m st) 5 True (_status st)) -- depth to search is 5 
